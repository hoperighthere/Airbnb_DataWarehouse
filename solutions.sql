...
select * from ct join public.dimlisting using(listing_id)
...
select dl.neighbourhood, sum(price)/count(*) as avg_price_for_neighbourhood from public.bookingsfact b
